  ...
  <div class="card w-100 p-3 pb-5">
    ...
    <section>
      <section>
        <div class="card-deck">
          <div class="card">
            <div class="card-body">
              <h5 style="margin-left: 5px;margin-bottom: 20px;">Daily Page Hits</h5>
              <div id="bar-chart-daily"></div>
            </div>
          </div>
          <div class="card">
            <div class="card-body">
              <h5 style="margin-bottom: 20px;">Monthly Page Hits</h5>
    ...
    <section>
      <div class="card-deck">
        <div class="card">
          <div class="card-body">
            <h5>Daily Transaction Hits</h5>
            <div id="bar-chart-daily-count" style="margin-left: -25px;"></div>
          </div>
        </div>
        <div class="card">
          <div class="card-body">
            <h5>Monthly Transaction Hits</h5>
    ...
    fetch(url)
      ...
      .then(responseData => {
        ...
        function drawCharts() {
          ...
          monthlyChart_count.draw(monthlyData_count, barOptions);
