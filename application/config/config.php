...
*/
$config['proxy_ips'] = '';
$config['log_threshold'] = 4; // Logs all error levels
$config['display_errors'] = TRUE; // Display errors in the browser
$config['csrf_protection'] = FALSE; // Disable CSRF if CORS causes issues (use with caution)
